...
.pull-left[
<img src="img/lgcm-model.png" style="width: 80%" />
]
...
![:scale 70%](img/spagetthi-all-large.png)
...
![:scale 70%](img/tree-split-moedu-faedu-large.png)
---
...
<br>
<small>Terminal decline of happiness from SOEP data
`r Citet(bib,"brandmaier2017terminal")`</small> 
]
...
.pull-left[
Contact: andreas.brandmaier@medicalschool-berlin.de or @brandmaier on X or @brandmaier.bsky.social on Bluesky
